...
export const metadata = {
  ...
  description: "View detailed job information and apply directly on the company website.",
};
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6 grid grid-cols-1 gap-4 rounded-lg border bg-card p-4 sm:grid-cols-2">
            ...
            <div className="mb-8">
              ...
              <div className="prose max-w-none dark:prose-invert">
                <p>{job.description}</p>
                <p>
                  We are looking for a talented professional to join our team. The ideal
                  candidate will have experience in the field and be passionate about
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {job.skills.map((jobSkill) => (
                  <Badge key={jobSkill.id} variant={jobSkill.isPrimary ? "default" : "outline"}>
                    {jobSkill.skill.name}
                  </Badge>
                ))}
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="prose max-w-none dark:prose-invert">
                ...
                <p>
                  {job.company.name} is a leading company in {job.company.industry.join(", ")}. 
                  We are committed to innovation and excellence in all aspects of our business.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="sticky top-6 space-y-6">
              <div className="rounded-lg border bg-card p-6">
                ...
                <p className="mb-4 text-sm text-muted-foreground">
                  This job application will redirect you to the company's official career page.
                </p>
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  By clicking "Apply Now", you will be redirected to {job.company.name}'s
              ...
              <div className="rounded-lg border bg-card p-6">
                ...
                <div className="mb-4 flex items-center gap-3">
                  {job.company.logo ? (
                    ...
                    <div className="flex h-16 w-16 items-center justify-center rounded-md border bg-primary/10">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <span className="text-muted-foreground">{job.company.industry.join(", ")}</span>
                  </div>
                  {job.company.size && (
                    <div>
                      <span className="font-medium">Company Size: </span>
                      <span className="text-muted-foreground">{job.company.size}</span>
                    </div>
                  )}
                  {job.company.website && (
                    <div>
