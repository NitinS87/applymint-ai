...
import { JOB_TYPES, EXPERIENCE_LEVELS, LOCATION_TYPES } from "@/lib/constants";
...
export function JobFilter({
  ...
  const getFilterTags = () => {
    ...
    if (filters.salaryMin || filters.salaryMax) {
      const salaryText = filters.salaryMin && filters.salaryMax
                      ...
                      {domains.map((domain) => (
                        <div key={domain.id} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              handleCheckboxToggle("domains", domain.id, filters.domains)
                            }
                          />
                          <Label htmlFor={`domain-${domain.id}-mobile`}>{domain.name}</Label>
                        </div>
                      ))}
                    </div>
                  </AccordionContent>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {JOB_TYPES.map((type) => (
                        <div key={type} className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor={`job-type-${type}-mobile`}>{type}</Label>
                        </div>
                      ))}
                    </div>
                  </AccordionContent>
                      ...
                      {EXPERIENCE_LEVELS.map((level) => (
                        <div key={level} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              handleCheckboxToggle("experienceLevels", level, filters.experienceLevels)
                            }
                          />
                          <Label htmlFor={`exp-level-${level}-mobile`}>{level}</Label>
                        </div>
                      ))}
                    </div>
                  </AccordionContent>
                      ...
                      {LOCATION_TYPES.map((type) => (
                        <div key={type} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              handleCheckboxToggle("locationTypes", type, filters.locationTypes)
                            }
                          />
                          <Label htmlFor={`location-type-${type}-mobile`}>{type}</Label>
                        </div>
                      ))}
                    </div>
                  </AccordionContent>
                          ...
                          {categorySkills.map((skill) => (
                            <div key={skill.id} className="flex items-center space-x-2">
                              <Checkbox
                                ...
                                onCheckedChange={() =>
                                  handleCheckboxToggle("skills", skill.id, filters.skills)
                                }
                              />
                              <Label htmlFor={`skill-${skill.id}-mobile`}>{skill.name}</Label>
                            </div>
                          ))}
                        </div>
                      </div>
                ...
                <AccordionItem value="salary">
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      <div>
                        <Label htmlFor="salary-min-mobile">Minimum Salary</Label>
                        <Input
                          type="number"
                      ...
                      <div>
                        <Label htmlFor="salary-max-mobile">Maximum Salary</Label>
                        <Input
                          type="number"
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => handleFilterChange("salaryCurrency", value)}
                        >
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => handleFilterChange("postedWithin", 1)}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => handleFilterChange("postedWithin", 7)}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => handleFilterChange("postedWithin", 14)}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => handleFilterChange("postedWithin", 30)}
                        />
              ...
              <div className="mt-4 grid grid-cols-1 gap-3">
                {domains.map((domain) => (
                  <div key={domain.id} className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor={`domain-${domain.id}`} className="flex-grow">
                      {domain.name}
                    </Label>
                  </div>
                ))}
          ...
          {filterTags.map((tag, index) => (
            ...
            >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="ml-1 h-4 w-4 rounded-full p-0 text-muted-foreground hover:bg-secondary hover:text-foreground"
